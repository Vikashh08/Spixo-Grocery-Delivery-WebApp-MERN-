        ...
        <div className="flex items-center gap-4">
          ...
          {deferredPrompt && (
            <button
              ...
              className={`hidden sm:flex items-center gap-2 text-[9px] font-black px-4 py-2 rounded-full uppercase tracking-widest border transition-all ${
                isScrolled || location.pathname !== "/"
            ...
            <div className="lg:hidden space-y-1 mb-4">
              ...
              {deferredPrompt && (
                <button
                  ...
                  className="w-full flex items-center gap-4 px-4 py-3.5 rounded-2xl bg-blue-50 text-blue-600 transition-all font-bold text-sm"
                >
